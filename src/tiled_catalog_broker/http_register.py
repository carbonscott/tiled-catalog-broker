...
def verify_registration_http(client):
    ...
    # Drill into first dataset -> first entity -> first artifact
    ...
    if path_keys and art_keys:
        print("\n  VERIFIED: both locators (Mode A) AND array children (Mode B).")
    else:
        print("\n  WARNING: dual-mode incomplete.")
        if not path_keys:
            print("    Missing: path_* locator metadata on entity")
