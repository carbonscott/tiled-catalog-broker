...
def reset_config_cache():
    ...
    import data_catalog_service.config as config
    config._config = None
    yield
    config._config = None
...
class TestLoadConfig:
    ...
    def test_loads_broker_section(self):
        from data_catalog_service.config import load_config
        cfg = load_config()
...
class TestGetLatestManifest:
    ...
    def test_finds_entities_manifest(self):
        from data_catalog_service.config import get_latest_manifest
    ...
    def test_fallback_pattern_is_generic(self):
        ...
        from data_catalog_service.config import get_latest_manifest, get_base_dir
...
class TestGetMaxEntities:
    ...
    def test_returns_integer(self):
        from data_catalog_service.config import get_max_entities
...
class TestGetTiledUrl:
    ...
    def test_returns_string(self):
        from data_catalog_service.config import get_tiled_url
        url = get_tiled_url()
...
class TestGetApiKey:
    ...
    def test_returns_string(self):
        from data_catalog_service.config import get_api_key
        key = get_api_key()
